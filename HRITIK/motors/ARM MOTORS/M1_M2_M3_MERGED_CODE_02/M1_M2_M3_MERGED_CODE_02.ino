...
void setup() {
  ...
  stepper1.setAcceleration(100); // Set the acceleration in steps per second per second
  stepper1.setCurrentPosition(0); // Set the current position to 0

  //motor 2
  stepper2.setMaxSpeed(100);     // Set the maximum speed in steps per second
  stepper2.setAcceleration(100); // Set the acceleration in steps per second per second
  stepper2.setCurrentPosition(0);

  //motor 3
  stepper3.setMaxSpeed(1000);     // Set the maximum speed in steps per second
  stepper3.setAcceleration(100); // Set the acceleration in steps per second per second
...
void loop() {
  ...
  if (currentTime - prevTime > 100) { // Check if 100 milliseconds have passed
    if (Serial.available()) {
