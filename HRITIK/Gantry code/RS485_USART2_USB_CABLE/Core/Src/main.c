...
/* USER CODE BEGIN PV */
uint8_t rx_data[256]; // Buffer for received data
/* USER CODE END PV */
...
// Function to set DE/RE for transmission mode
void RS485_SetTransmissionMode(void)
{
    HAL_GPIO_WritePin(RS485_DE_RE_GPIO_Port, RS485_DE_RE_Pin, GPIO_PIN_SET);
}

// Function to set DE/RE for reception mode
void RS485_SetReceptionMode(void)
{
