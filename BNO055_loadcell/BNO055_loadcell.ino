...
if (lastw == quat.w()&&lastx==quat.x()&&lasty==quat.y()&&lastz==quat.z())
 ...
 lastz = quat.z();
  ...
  //gram_force = (units/1000)*9.80665; 
  //formula of Gram-force (gf) = Grams (g) × Acceleration due to gravity (9.80665 m/s²) 
  //newton = gram_force*0.009807; 
  //formula of newtons = gram-force × 0.009807
